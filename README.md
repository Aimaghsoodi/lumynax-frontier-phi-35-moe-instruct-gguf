...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-frontier-phi-35-moe-instruct-gguf --local-dir lumynax-frontier-phi-35-moe-instruct-gguf
cd lumynax-frontier-phi-35-moe-instruct-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-frontier-phi-35-moe-instruct-gguf -i
```
